<script>
    $(document).ready(function(){
        $("#bouton").click(function(){
            ...
            if(prenom != "" && jour_naissance != "" && mois_naissance != "" && annee_naissance != "" && cin != "" && adresse != "" && nume_phone != "" && mot_passe != "" && confirm_mot_passe != ""){
                $.ajax({
                    url: "employe_enregistrement.php",
                    type: "post",
                    data: {
        ...
        $(document).on("click", "#modifier", function(){
            // ANY ANATY employe_selection.php NO MISY IO bouton modifier io 
            $(".conteneur_modification").show()
            let id_point_vente = $(this).data("id");

            $.ajax({
                url: "employe_affiche_form_modification.php",
                type: "post",
                data: {id: id_point_vente},
                success: function(data){
                    $(".conteneur_modification").html(data)
                    // ANATY employe.php NO MISY IO DIV conteneur_modification IO
                }
            })
        })
 ...
 $(document).on("click", "#supprimer", function(){
                ...
                $.ajax({
                    url: "employe_affiche_confirmation_supprimer.php",
                    type: "post",
                    data: {
