...
for($i_emballage = 0; $i_emballage < $nb_tab_emballage; $i_emballage++){
    ...
    $reponse .= "<label>
                    <input type='checkbox' value='{$id_emballage}' class='emballage_modifier' />
                    {$nom_emballage}
                </label>
                <section id='unite_par_emballage_{$id_emballage}_modifier' class='unite_par_emballage'></section>";
}
